...
mn_height = []
with open('/Users/mcallister/projects/Alert_INP2016/bin/working/CLUSLIST_3','r') as f:
...
fig, axes = plt.subplots(2,3,figsize=(16, 6), facecolor='w', edgecolor='k')
...
plt.savefig('ALERT_cluster_all_trajs_from_HYSPLIT_240hr_backtrajectories-3clusters-Alert_SSI_March_2016.png', bbox_inches='tight') 
