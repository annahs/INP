...
if traj_type == 'posn_matrix':
	file_location = '/Users/mcallister/projects/INP_Meng/trajectories/'+ location +' 10d/sample'+ str(day_to_plot) +'_'+ str(sample_no) + 'w_PBL'
	file_position = 17

if traj_type == 'met_ensemble':
	file_location = '/Users/mcallister/projects/INP_Meng/trajectories/'+ location +' 10d/sample'+ str(day_to_plot) +'_'+ str(sample_no) + 'w_ens'
	file_position = 14
...
if save_fig == True:
	plt.savefig(location + '_' + str(day_to_plot) +'-'+ str(sample_no)  + '_' +traj_type + bl +'.pdf',format = 'pdf', bbox_inches='tight') 
